...
% For class S-
U1 = normrnd(-1.167,sqrt(0.6),[1 100]);
U2 = normrnd(-1.09,sqrt(0.6),[1 100]);

% For class S+
U3 = normrnd(1.167,sqrt(1.2),[1 100]);
U4 = normrnd(1.09,sqrt(1.2),[1 100]);
...
% For class S-
X1 = normrnd(-1.167,sqrt(0.6),[1 100]);
X2 = normrnd(-1.09,sqrt(0.6),[1 100]);

% For class S+
X3 = normrnd(1.167,sqrt(1.2),[1 100]);
X4 = normrnd(1.09,sqrt(1.2),[1 100]);
